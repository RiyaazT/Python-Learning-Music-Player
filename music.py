...
mixer.init()
song_path = resource_path(path.join("music.mp3"))
...
with dpg.window(label="Winamp v1", width=800, height=400):
...
dpg.create_viewport(title='This is not a rickroll', width=800, height=400, decorated=False)
dpg.setup_dearpygui()
dpg.show_viewport()
dpg.start_dearpygui()
dpg.destroy_context()
